...
if uploaded_file is not None:
    ...
    # ==================================================
    #
    # The stage registry (metadata + processing handler for all 21
    # pipeline stages) lives in modules/stages.py, and the sidebar
    # controls are declared in modules/controls.py. Adding a stage or
    # a parameter means one new entry in one of those files, rather
    # than edits scattered through this one.
